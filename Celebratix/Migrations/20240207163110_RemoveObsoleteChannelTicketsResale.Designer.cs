...
namespace Celebratix.Migrations
{
    ...
    [Migration("20240207163110_RemoveObsoleteChannelTicketsResale")]
    partial class RemoveObsoleteChannelTicketsResale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Celebratix.Common.Models.DbModels.Channel", b =>
                {
                    ...
                    b.Property<Guid?>("CustomBackgroundId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ResaleDisabledDescription")
                        .HasColumnType("text");

                    b.Property<bool>("ResaleEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("ResaleRedirectUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Celebratix.Common.Models.DbModels.ChannelEventTicketType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ChannelEventId");

                    b.HasIndex("EventTicketTypeId");

                    b.ToTable("ChannelEventTicketTypes");
                });
            ...
            modelBuilder.Entity("Celebratix.Common.Models.DbModels.Channel", b =>
                {
                    ...
                    b.HasOne("Celebratix.Common.Models.DbModels.ImageDbModel", "CustomBackground")
                        .WithMany()
                        .HasForeignKey("CustomBackgroundId");

                    b.Navigation("Business");

                    b.Navigation("CustomBackground");
                });
            ...
            modelBuilder.Entity("Celebratix.Common.Models.DbModels.ChannelEventTicketType", b =>
                {
                    b.HasOne("Celebratix.Common.Models.DbModels.ChannelEvent", "ChannelEvent")
                        .WithMany("SelectedTicketTypes")
                        .HasForeignKey("ChannelEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Celebratix.Common.Models.DbModels.EventTicketType", "EventTicketType")
                        .WithMany()
                        .HasForeignKey("EventTicketTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChannelEvent");
            ...
            modelBuilder.Entity("Celebratix.Common.Models.DbModels.ChannelEvent", b =>
                {
                    b.Navigation("SelectedTicketTypes");
                });
